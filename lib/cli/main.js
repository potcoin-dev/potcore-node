...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `potcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ potcore-node add wallet-service');
      console.log('    $ potcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ potcore-node remove wallet-service');
      console.log('    $ potcore-node remove insight-api');
      console.log();
    });
