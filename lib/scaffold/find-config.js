...
/**
 * Will return the path and potcore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'potcore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'potcore-node.json'))
  };
}
